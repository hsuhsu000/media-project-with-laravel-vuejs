...
@section('content')
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin#updatePost', $postDetails['post_id']) }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Post Name</label>
                        <input type="text" name="postName" class="form-control"
                            value="{{ old('postName', $postDetails['title']) }}">
                        @error('postName')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="postDescription" id="" cols="30" rows="10" class="form-control">{{ old('postDescription', $postDetails['description']) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <img width="100%"
                            @if ($postDetails['image'] == null) src="{{ asset('defaultImage/images.png') }}"
                    ...
                    <a href="{{ route('admin#post') }}"><button type="button" class="btn btn-dark">Create</button></a>
                </form>
            </div>
            <!-- /.card-body -->
        </div>
